...
//   const { user, acquireToken, isAuthenticated, isInitialized, isLoading } = useAuth();
//   const { users, loading: usersLoading, error: usersError } = useUsers();
//   const [activeSection, setActiveSection] = useState('todaysFocus');
//   const [taskStats, setTaskStats] = useState({
//     toDo: 0,
//     inProgress: 0,
//     completed: 0,
...
//         {tasks.length === 0 ? (
//           <div className="text-center py-8 text-gray-500">
//             <div className="text-sm">No tasks at the moment</div>
//           </div>
//         ) : (
//           <div
//             className="space-y-3 max-h-80 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100"
...
//         <TaskSection
//           tasks={sections.find((s) => s.key === activeSection)?.tasks || []}
//           bgClass={sections.find((s) => s.key === activeSection)?.bgClass || 'bg-gray-50 border-gray-100'}
//           textClass={sections.find((s) => s.key === activeSection)?.textClass || 'text-gray-500'}
//           isOverdue={sections.find((s) => s.key === activeSection)?.isOverdue || false}
//         />
