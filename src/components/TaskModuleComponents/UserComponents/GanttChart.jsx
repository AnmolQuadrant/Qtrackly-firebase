...
//       fetchTasks();
//     }
//   }, [isAuthenticated, isInitialized, user?.id, viewMode, currentDate]);
...
//       const quarterStartMonth = Math.floor(startDate.getMonth() / 3) * 3;
//       startDate = new Date(startDate.getFullYear(), quarterStartMonth, 1);
//       const quarterEnd = new Date(startDate.getFullYear(), quarterStartMonth + 3, 0);
//       const daysInQuarter = Math.ceil((quarterEnd - startDate) / (1000 * 60 * 60 * 24)) + 1;
...
//         if (todayIndex >= 0) {
//           const cellWidth = viewMode === 'hour' ? window.innerWidth / 24 : viewMode === 'week' ? window.innerWidth / 7 : 40;
//           const containerWidth = scrollContainerRef.current.clientWidth;
//           const scrollPosition = Math.max(0, todayIndex * cellWidth - containerWidth / 2);
//           scrollContainerRef.current.scrollLeft = scrollPosition;
//         }
//       }, 100);
//     }
//   }, [tasks, currentDate, viewMode, loading]);
...
//     ? Math.max(20, window.innerWidth / 24)
//     : viewMode === 'week'
//     ? Math.max(20, window.innerWidth / 7)
//     : 40;
