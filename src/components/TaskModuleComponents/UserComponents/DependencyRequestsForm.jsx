...
//                   className="flex-1 bg-purple-600 text-white font-medium py-2 px-4 rounded hover:bg-purple-700 transition-all duration-200 flex items-center justify-center"
//                 >
...
// // const DependencyRequestForm = ({ taskId, onClose, onSave }) => {
// //   const { users, loading: usersLoading, error: usersError } = useUsers();
// //   const { isAuthenticated, isLoading: authLoading, user, login } = useAuth();
// //   const { aesKey, aesIV } = fetchEncryptionKeys();
